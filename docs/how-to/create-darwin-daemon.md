...
| Field | Purpose |
|-------|---------|
| `Label` | Unique reverse-domain identifier (e.g. `org.omlx.server`) |
...
Create `tests/test-my-service.nix` to validate option defaults and custom values. Follow the existing service test patterns.
